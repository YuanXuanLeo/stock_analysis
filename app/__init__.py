...
def about():
    ...
    title = 'US-TOCK'
    name_ha = 'AAPL'
    return render_template('about.html', active = active, title= title, name_ha = name_ha)
...
def index():
    ...
    title = 'US-TOCK'
    name_ha = 'AAPL'
    return render_template('model.html', active = active, title= title, name_ha = name_ha)
...
# # # def model():
# #     # tiele = 'BDSE27-1'
# #     # return render_template('model.html', tiele = tiele)
...
# #     tiele = '404'
# #     return render_template('templates/model.html' ,tiele = tiele), 404
...
#     if q :
#         q = upname(q)
#         conn = pymysql.connect(host='35.194.202.150',user='root',password='a000000',db='stock_analysis')
#         cur = conn.cursor()
